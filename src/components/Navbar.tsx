...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="flex justify-between items-center lg:px-8 b-2 h-16 text-sm cursor-pointer font-light">
      <section className="flex justify-between lg:w-0 w-full items-center px-3">
      ...
      >
        <ul className="lg:pl-10 flex justify-center pb-11 lg:pb-0">
          <Link to="/catalog">
            <li className="border-b-2 pb-1 border-b-gray-500">Catalog</li>
          </Link>
        </ul>
        <div className="flex lg:justify-between lg:h-0 h-48">
          <ul className=" flex justify-between w-full lg:w-64 items-center flex-col lg:flex-row">
            <li>About</li>
            <li>Lookbook</li>
            <li>Contact</li>
          </ul>
