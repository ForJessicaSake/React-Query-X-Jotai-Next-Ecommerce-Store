...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="flex justify-between items-center lg:px-10  h-20 text-sm cursor-pointer">
      ...
      >
        <ul className="flex lg:flex-row flex-col items-center justify-between lg:w-96 w-full lg:h-0 h-full">
        <li>Home</li>
        <li>Shop</li>
        <li>About Us</li>
        <li>Blog</li>
