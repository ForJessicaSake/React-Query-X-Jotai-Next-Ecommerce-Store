...
function Header() {
  return (
    <header className="flex flex-col lg:flex-row justify-between lg:pl-16 px-6 lg:px-0 pt-10 bg-Header">
    ...
    <figure>
        <img src ={header} alt="living room furniture" className="lg:w-9/12 lg:h-9/12 w-full"/>
    </figure>
